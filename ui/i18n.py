...
FR: dict[str, str] = {
    ...
    "routing.view.best.on": "Vue 3D : seul le meilleur agent est affiché.",
    "routing.view.best.off": "Vue 3D : toutes les trajectoires sont affichées.",
...
EN: dict[str, str] = {
    ...
    "routing.view.best.on": "3D view: showing the best agent only.",
    "routing.view.best.off": "3D view: showing every trajectory.",
