...
CONFIG = {
    ...
    "segment_violation_penalty": 200.0,
    "segment_test_steps": 10,
    ...
    "stagnation_freeze_start": 150,  # 📉 Modifié : Fige l'apprentissage beaucoup plus tôt si ça stagne
